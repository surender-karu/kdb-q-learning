...
For more information on the telemetry data we collect and how it is used, please refer to the Telemetry Data Statement (https://kx.com/legal/kdb-x-telemetry-data-statement-05-26), and for details on how we handle personal data more generally, please refer to our Privacy Policy: https://kx.com/privacy-policy/. 
EOF
)
...
KX collects telemetry data relating to the operation and usage of KDB-X Community Edition, including performance metrics, configuration and settings, and diagnostics relating to the operation of KDB-X Community Edition. This telemetry may include identifiers (such as IP address, User ID, and license information), which can be used to associate telemetry data with a user, device, or account. 
...
- Identification: Used to identify and distinguish users, devices and installations in order to provide and manage access to KDB-X Community Edition, including licensing, authentication, and ensuring that usage can be attributed to the correct user or environment.   

- Feature Usage and Insights: Used to understand how features and functionality of KDB-X Community Edition are used in practice, including which features are accessed and how they are used, to improve existing functionality and inform the development of new features. 

- System Performance and Resource Context: Used to understand the technical environment and performance of KDB-X Community Edition, including system configuration, resource utilisation, and diagnostics related to issues encountered, in order to support product optimisation and ensure KDB-X Community Edition operates effectively across different technical environments. 

In addition to the purposes described above, KX may use telemetry data, including personal information, for broader analytics and business purposes. This includes analysing how KDB-X Community Edition is used across users and environments, generating aggregated insights, and developing internal models or scores to better understand usage patterns, customer engagement, and potential interest in our products and services. These activities do not result in automated decisions that produce legal or similarly significant effects, but may inform how we communicate with you, including providing product updates, service-related communications, and, where permitted by applicable law, marketing or promotional communications. 

$(bold "Sharing of Telemetry Data")

KX may share data, including personal information, with third parties service providers that support the operation, analysis, and improvement of KDB-X Community Edition. These third-party service providers act on our behalf and are subject to contractual and other safeguards governing their use of the data.  
